namespace ROOT.CIMV2.Win32 {
    ...
    // An Early Bound class generated for the WMI class.Win32_Keyboard
    public class Keyboard : System.ComponentModel.Component {
        
        // Private property to hold the WMI namespace in which the class resides.
        private static string CreatedWmiNamespace = "root\\CimV2";
        
        // Private property to hold the name of WMI class which created this class.
        private static string CreatedClassName = "Win32_Keyboard";
        ...
        public Keyboard(string keyDeviceID) {
            this.InitializeObject(null, new System.Management.ManagementPath(Keyboard.ConstructPath(keyDeviceID)), null);
        }
        
        public Keyboard(System.Management.ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(Keyboard.ConstructPath(keyDeviceID)), null);
        }
        
        public Keyboard(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public Keyboard(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public Keyboard(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public Keyboard(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public Keyboard(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public Keyboard(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("An indication of whether the device is locked, preventing user input or output.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsNumberOfFunctionKeysNull {
            get {
                if ((curObj["NumberOfFunctionKeys"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        public ushort NumberOfFunctionKeys {
            get {
                ...
                return ((ushort)(curObj["NumberOfFunctionKeys"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("An integer indicating whether a hardware-level password is enabled at the keyboar" +
            "d (value=4), preventing local input. Other values are:  \"Disabled\" (3), \"Not Imp" +
            "lemented\" (5), \"Other\" (1) and \"Unknown\" (2).")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public PasswordValues Password {
            get {
                if ((curObj["Password"] == null)) {
                    return ((PasswordValues)(System.Convert.ToInt32(0)));
                }
                return ((PasswordValues)(System.Convert.ToInt32(curObj["Password"])));
            }
        }
        ...
        private bool ShouldSerializeNumberOfFunctionKeys() {
            if ((this.IsNumberOfFunctionKeysNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private static string ConstructPath(string keyDeviceID) {
            string strPath = "root\\CimV2:Win32_Keyboard";
        ...
        public static KeyboardCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static KeyboardCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static KeyboardCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static KeyboardCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static KeyboardCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "Win32_Keyboard";
            ...
            return new KeyboardCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static KeyboardCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static KeyboardCollection GetInstances(System.Management.ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static KeyboardCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\CimV2";
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_Keyboard", condition, selectedProperties));
            System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new KeyboardCollection(ObjectSearcher.Get());
        }
        ...
        public static Keyboard CreateInstance() {
            ...
            return new Keyboard(tmpMgmtClass.CreateInstance());
        }
        ...
        public class KeyboardCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public KeyboardCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new Keyboard(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual System.Collections.IEnumerator GetEnumerator() {
                return new KeyboardEnumerator(privColObj.GetEnumerator());
            }
            
            public class KeyboardEnumerator : object, System.Collections.IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public KeyboardEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new Keyboard(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
